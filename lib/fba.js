...
const complex = exports.complex = {
  ...
  InboundShipmentItems: function () {
    const obj = new mws.ComplexList('InboundShipmentItems.member');
  ...
  InboundShipmentPlanRequestItems: function () {
    const obj = new mws.ComplexList('InboundShipmentPlanRequestItems.member');
  ...
  CreateLineItems: function () {
    const obj = new mws.ComplexList('Items.member');
